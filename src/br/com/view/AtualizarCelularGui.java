 ...
 */
public class AtualizarCelularGui extends javax.swing.JFrame {
     ...
     */
    public AtualizarCelularGui(int selecionado, int cdCelular, CelularTableModel mtb) {
        initComponents();
        txId.setEditable(false);
        linhaSelecionada = selecionado;
        codigoCelular = cdCelular;
        model = mtb;


        CelularController mc = new CelularController();
        Celular ma = new Celular();
        ma = mc.listarCelularById(cdCelular);
    ...
    private void botaoSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoSalvarActionPerformed
        ...
        if (txNome.getText().length() > 0) {
            ...
            CelularController mc = new CelularController();
            if (mc.cadastrar(m)){
                model.updateCelular(linhaSelecionada, m);
            } else {
            }
            dispose();
        }
