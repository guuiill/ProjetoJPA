...
public class CategoriaGui extends javax.swing.JFrame {
    ...
    public CategoriaGui() {
        ...
        lista = a.listarCategoria();

        //cria o modelo de Produto      
        model = new CategoriaTableModel(lista);
    ...
    private void btInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btInserirActionPerformed
        InserirCategoriaGui im = new InserirCategoriaGui(model);
    ...
    private void btRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btRemoverActionPerformed
        ...
        if (selecionado >= 0) {
            ...
            Categoria m = model.getCategoria(selecionado);
            CategoriaController mc = new CategoriaController();
            if (mc.excluir(m.getId())){
            model.removeCategoria(selecionado);
            }
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        if (selecionado >= 0) {
            Integer cdCategoria = (Integer) model.getValueAt(selecionado, 0);
            AtualizarCategoriaGui am = new AtualizarCategoriaGui(selecionado, cdCategoria, model);
    ...
    private void efetuaPesquisa() {
        ...
        List<Categoria> lista = new ArrayList<Categoria>();
        CategoriaController a = new CategoriaController();
        lista = a.listarCategoriasByDescricao(nome);
        model.limpar();
