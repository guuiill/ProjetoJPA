 ...
 */
public class CelularGui extends javax.swing.JFrame {

    private CelularTableModel model;

    public CelularGui() {
        initComponents();
        List<Celular> lista = new ArrayList<Celular>();
        CelularController cc = new CelularController();
        lista = cc.listarCelular();

        //cria o automovel de Produto      
        model = new CelularTableModel(lista);
    ...
    private void btInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btInserirActionPerformed
        InserirCelularGui im = new InserirCelularGui(model);
        im.setVisible(true);
    ...
    private void btRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btRemoverActionPerformed
        ...
        if (selecionado >= 0) {
            ...
            CelularController cc = new CelularController();
            if (cc.excluir(i)){
            model.removeCelular(selecionado);
            }
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        if (selecionado >= 0) {
            Integer cdCelular = (Integer) model.getValueAt(selecionado, 0);
            AtualizarCelularGui am = new AtualizarCelularGui(selecionado, cdCelular, model);
            am.setVisible(true);
        } else {
    ...
    private void efetuaPesquisa() {
        String id = txPesquisa.getText();
        List<Celular> lista = new ArrayList<Celular>();
        CelularController a = new CelularController();
        lista = a.listarCelularByNome(id);
        model.limpar();
