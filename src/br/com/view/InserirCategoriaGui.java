...
public class InserirCategoriaGui extends javax.swing.JFrame {
     ...
     */
    public InserirCategoriaGui(CategoriaTableModel mtb) {
        initComponents();
        model = mtb;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Inserir Celular");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(57, 11, 67, 14);
    ...
    private void botaoSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoSalvarActionPerformed
        ...
        if ((txDescricao.getText().length() <= 0))
            ...
            String msg = "";
            if (txDescricao.getText().length() <= 0) {
                msg = msg + "Informe um ano de fabricação para a categoria\n";
            }
           ...
           mc.cadastrar(c);
           CategoriaGui cg = new CategoriaGui();
           cg.setVisible(false);
    ...
    private Categoria pesquisar ( int id){
        CategoriaController mc = new CategoriaController();
        return mc.listarCategoriaById(id);
    }
